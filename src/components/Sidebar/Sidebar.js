...
import './Sidebar.css';
//  Sidebar component that holds cached amounts and durations
const Sidebar = (props) => {
    //  Variable to hold a list of cards having cached amount and duration
    let cacheAmountDisplay = null;
    //  If only amounts and duration is cached
